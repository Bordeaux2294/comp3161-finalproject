...
CREATE TABLE discussionforum(fid int PRIMARY KEY NOT NULL, cid varchar(255), fname varchar(255), fdatecreated datetime, fthreadamt int);
CREATE TABLE discussionthread(tid int PRIMARY KEY NOT NULL, fid int, cid varchar(255), uid int, tname varchar(255), tdatecreated datetime, treplyamount int);
CREATE TABLE reply(rid int PRIMARY KEY NOT NULL, tid int, fid int, cid varchar(255), uid int, rname varchar(255), rdatecreated datetime, rreplyamount int);
CREATE TABLE assignment(aid int PRIMARY KEY NOT NULL, sid int, cid varchar(255), aname varchar(255), agrade int, adatesubmitted datetime);
CREATE TABLE event(evid int primary key NOT NULL, cid varchar(255), uid int, ename varchar(255), edatecreated datetime, edateofevent datetime);